...
const double Sa1 = 14.18; //Dato inventado (minutos^{-1})
const double Sa2 = 0.4*14.18; //Dato inventado (minutos^{-1})

const int MY_MAX = 21474836; //Normalización de los números aleatorios

const double prob_net = 0.01;
