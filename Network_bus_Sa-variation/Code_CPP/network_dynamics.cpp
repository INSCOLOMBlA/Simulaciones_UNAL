...
void Gillespie_estaciones(station &the_station, std::vector<agents> &aux, int &exposed, int i, double t, int id_NP, int count_NP, double ran_1, double ran_2, double ran_3, double Sa_in, double Sa_out, int T)
{
  //Inicio el tiempo
  double aux_t=0;
  ...
  while(aux_t<T){
    ...
    a2 = Sa_in; //Un susceptible entra a la estación.
    a3 = Sa_out; //Una persona sale de la estación.
    /*
